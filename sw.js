...
const ASSETS = [
  ...
  './manifest.webmanifest', './LICENSE.md', './universe/', './fusio-total/', './inter-nos-creative/', './cambra-nua-2/', './formiga.css', './formiga.js', './assets/cambra-nua.svg', './assets/icon.svg', './assets/icon-192.png', './assets/icon-512.png', './assets/apple-touch-icon.png'
];
