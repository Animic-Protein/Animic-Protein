const CACHE = 'codex-viu-canonical-v63';
const ASSETS = [
  ...
  './manifest.webmanifest', './LICENSE.md', './universe/', './fusio-total/', './inter-nos-creative/', './cambra-nua-2/', './portal-multimedia/', './portal-multimedia/index.html', './portal-multimedia/model.js', './portal-multimedia/storage.js', './formiga.css', './formiga.js', './assets/cambra-nua.svg', './assets/icon.svg', './assets/icon-192.png', './assets/icon-512.png', './assets/apple-touch-icon.png'
];
