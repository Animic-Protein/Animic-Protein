...
'brodsky-avorriment|continuum-musicalis':{title:'Temps nu',text:'El Continuum musicalis rep el seu suport temporal: la repetició deixa de ser una còpia morta i es converteix en el medi on l’oïda detecta llindars, diferències i durada.',action:'Activa el protocol Temps nu: set repeticions intactes, una mutació mínima i un retorn.'},
...
'continuum-musicalis|temps-nu':{title:'Laboratori de redundància',text:'Temps nu converteix la redundància en instrument del Continuum: repetició, llindar, mutació mínima i retorn formen un cicle traçable, reversible i audible.',action:'Repeteix 7 vegades; a la 8a varia només timbre, accent, altura o silenci; a la 9a retorna i compara.'},
