...
function applyBeta12(){
  ...
  setTimeout(normalizeArchiveVocabulary,100);
  setTimeout(normalizeArchiveVocabulary,600);
  ...
  setText($('#trace'),'🐜 β·12 · Occam: una font, instruments pertinents, una memòria viva.');
