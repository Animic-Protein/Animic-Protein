(()=>{
  ...
  panel.innerHTML=`<p class="kicker">INTER NOS · Relació activa</p><h3 data-inter-nos-title>Dos nodes, una tercera cosa</h3><p data-inter-nos-output></p><div class="rosa-inter-nos-actions"><button type="button" data-inter-nos-seed hidden>Sembrar relació</button><button type="button" data-inter-nos-clear>Netejar relació</button></div>`;
  consoleEl.appendChild(panel);
  const output=panel.querySelector('[data-inter-nos-output]'),title=panel.querySelector('[data-inter-nos-title]'),clear=panel.querySelector('[data-inter-nos-clear]'),seedButton=panel.querySelector('[data-inter-nos-seed]');
